...
function runDiagnosisGame(seed, profileTriplet, charterEnabled) {
  ...
  return {
    ...
    actsPassed: finalState.acts.passed.map(a => a.actId),
    bankCharterPassed: !!finalState.flags.bankCharterPassed,
    fundingPassed: !!finalState.flags.fundingPassed,
    assumptionPassed: !!finalState.flags.assumptionPassed,
    tariffPassed: !!finalState.flags.tariffPassed,
    telemetry: tel,
  };
}
